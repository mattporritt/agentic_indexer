...
"""Query, retrieval, planning, and safety services over the SQLite index.

This module is the current composition layer for the project. It sits on top of
the extracted SQLite facts and synthesizes them into bounded JSON-friendly
responses for the CLI.

The major layers in this file are:
...
- hybrid retrieval:
  - ``semantic_context``
- agent-oriented planning and safety:
  - ``propose_change_plan``
  - ``assess_test_impact``
...
later layers reuse those anchors instead of inventing disconnected planners or
retrievers.
"""
...
from moodle_indexer.agent_safety import (
    ...
    _collect_do_not_assume,
    _collect_environment_steps,
    _collect_manual_review_points,
    _collect_post_edit_checks,
    _collect_pre_edit_checks,
    _collect_test_impact_tests,
    _collect_watch_points,
    _component_root_for_path,
    _dedupe_safety_items,
    _plan_items,
    _representative_service_pattern,
    _safety_item,
    _same_component_root,
    _synthesize_execution_guardrails,
    _synthesize_test_impact,
    _test_file_path,
)
